...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assetss/plugins/jvectormap/jquery-jvectormap-2.0.3.min.css') }}"/>
    <link rel="stylesheet" href="{{ asset('assetss/plugins/charts-c3/plugin.css') }}"/>
    <link rel="stylesheet" href="{{ asset('assetss/plugins/morrisjs/morris.min.css') }}" />
    <!-- Custom Css -->
...
<div class="page-loader-wrapper">
    <div class="loader">
        <div class="m-t-30"><img class="zmdi-hc-spin" src="{{ asset("assetss/images/loader.svg") }}" width="48" height="48" alt="Aero"></div>
        <p>Please wait...</p>
    </div>
</div>
    ...
    <div class="menu">
        <ul class="list">
            ...
            <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-assignment"></i><span>Reports</span></a>
                <ul class="ml-menu">
                    <li><a href="/commune/dashboard/reports">View Reports </a></li>
...
<section class="content">
    ...
    <script src="{{ asset('assetss/bundles/c3.bundle.js') }}"></script>

    <script src="{{ asset('assetss/bundles/mainscripts.bundle.js') }}"></script>
